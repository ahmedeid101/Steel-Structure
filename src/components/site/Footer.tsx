      ...
      <div className="mx-auto grid max-w-7xl gap-12 px-6 py-16 md:grid-cols-4">
        ...
        <div>
          ...
          <ul className="mt-4 space-y-3 text-sm text-muted-foreground">
            ...
            <li className="flex items-center gap-2"><Linkedin className="h-4 w-4" /><a href={site.linkedin} target="_blank" rel="noreferrer" className="hover:text-foreground">LinkedIn</a></li>
          </ul>
        </div>
      </div>
